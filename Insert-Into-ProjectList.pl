...
$statement->execute();
$statement = $dbh->prepare("INSERT INTO ProjectList VALUES($projectNumber, $codeName, $databaseServer, $server, $temperature, $numberOfRun, $numberOfClone, $numberOfAtoms, $description)");
$statement->execute();
